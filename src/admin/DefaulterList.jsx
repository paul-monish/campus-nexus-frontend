...
const DefaulterList = () => {
  ...
  const handleValueChange = (event) => {
    ...
    switch (parseInt(event.target.value)) {
      case 1:
        getDefaulterList("sem1");
        break;
      case 2:
        getDefaulterList("sem2");
        break;
      case 3:
        getDefaulterList("sem3");
        break;
      case 4:
        getDefaulterList("sem4");
        break;
      case 5:
        getDefaulterList("sem5");
        break;
      case 6:
        getDefaulterList("sem6");
        break;
      case 7:
        getDefaulterList("sem7");
        break;
      case 8:
        getDefaulterList("sem8");
        break;
      default:
        Swal.fire({
          icon: "error",
                ...
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">
                      List of Student of Outstanding Fees
                    </h3>
                  </div>
                  {/* {JSON.stringify(rows)} */}
                  {/* /.card-header */}
